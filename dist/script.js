...
const modals = () => {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 60000); // временно закоментировал чтоб не мешало
};
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', dedline);
});
}();
/******/ })()
;
